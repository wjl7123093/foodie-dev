package com.snow.pojo.bo.center;
...
@ApiModel(value = "用户中心对象", description = "从客户端，由用户传入的数据封装在此 entity 中")
public class CenterUserBO {

    @ApiModelProperty(value = "用户名", name = "username", example = "jaychou", required = false)
    ...
    private Integer sex;
    @ApiModelProperty(value = "生日", name = "birthday", example = "1980-08-20", required = true)
